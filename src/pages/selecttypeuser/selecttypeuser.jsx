                          ...
                          <div className='grid h-full relative'>
                            ...
                            <div className='absolute bottom-[5%] right-3 '>
                              <div className="w-[8rem] h-auto rounded-3xl [background:linear-gradient(180deg,_rgba(91,_45,_144,_0.6),_rgba(0,_54,_163,_0.6))] items-center pl-4 border-none ">
                                  ...
                                  <label htmlFor="bordered-radio-1" className="w-full my-4 ml-2 text-2xl text-white  ">เลือก</label>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className='w-[49%] '>
                          <div className='grid h-full relative'>
                            ...
                            <div className='absolute bottom-[13%] px-4'>
                              ...
                              <p className="text-sm m-0"> เหมาะสำหรับ นิติบุคคล และผู้ที่ต้องทำ </p>
                            ...
                            <div className='absolute bottom-[5%] right-3 '>
                              <div className="w-[8rem] h-auto rounded-3xl [background:linear-gradient(180deg,_rgba(91,_45,_144,_0.6),_rgba(0,_54,_163,_0.6))] items-center pl-4 border-none ">
                                  <input id="bordered-radio-2" type="radio" value="" name="bordered-radio" 
                                    className="w-5 h-5 my-4 border-white outline-blue-50 bg-gray-100 focus:bg-blue-500 focus:outline-none ring-blue-500 " />
                                  <label htmlFor="bordered-radio-2" className="w-full my-4 ml-2 text-2xl text-white  ">เลือก</label>
                              </div>
                            </div>
                          </div>
                        </div>
                    </div>
                        <div className='my-4 flex justify-end mt-2'>
                          ...
                          text-white text-lg justify-center text-center w-auto h-auto rounded-3xl px-10 py-3'to="/informationperson" >
                              ดำเนินการต่อ
                          </Link>
                      </div>
                  </div>
