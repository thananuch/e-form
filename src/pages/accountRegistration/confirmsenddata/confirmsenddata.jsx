              ...
              <div className="h-[14.5rem] flex flex-col pt-[1rem] px-[0rem] pb-[0rem] box-border items-start justify-start gap-[1.13rem]">
                ...
                <div className="flex flex-col items-start justify-start gap-[2rem] text-[0.88rem] text-white">
                  <div className="h-[1.5rem] flex flex-row items-center justify-start gap-[0.25rem]">
                    <div className="relative leading-[150%] font-bold">
                  ...
                  <div className="h-[1.5rem] flex flex-row items-center justify-start gap-[0.25rem]">
                    <div className="relative leading-[150%] font-bold">
                      <AiOutlineCheck></AiOutlineCheck> ข้อมูลบัญชีผู้ใช้งาน
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="w-[90%] mx-auto">
                ...
                <div className="grid grid-cols-3 gap-8 ">
                  <div className="grid-flow-row gap-[0.5rem] ">
                    <div className="text-sm font-bold my-1 ">ประเภทบัญชี</div>
                    <div>บุคคลทั่วไป</div>
                  </div>
                  <div className="grid-flow-row gap-[0.5rem] ">
                    <div className="text-sm font-bold my-1 ">ชื่อผู้ใช้งาน</div>
                    <div>testsys2532</div>
                  </div>
                  <div className="grid-flow-row gap-[0.5rem] ">
                    <div className="text-sm font-bold my-1 ">อีเมล</div>
                    <div>pathaweeboriboon@gmail.com</div>
                  </div>
                </div>
                <div className="grid grid-cols-3 gap-8 mt-4">
                  <div className="grid-flow-row gap-[0.5rem] ">
                    <div className="text-sm font-bold my-1 ">รหัสผ่าน</div>
                    <div>*******333</div>
                  </div>
                </div>
