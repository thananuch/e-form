...
function Termsconditions() {
  ...
  return (
    <>
      <Content />
      <div className="bg-gradient-to-b from-EEF0F6 to-EFEAE1">
        <div className="max-w-[90rem] mx-auto px-4 p-10 flex">
          <div className="w-[20rem] py-4 rounded-l-xl bg-gradient-to-b from-977EBB to-6482C2 px-10 flex flex-row gap-[2rem]">
            <div className="bg-[#BABFDF] py-12 px-[0.5rem] items-center justify-start rounded-full flex flex-col gap-[3.38rem] h-[75%]">
            ...
            <div className="flex-1 flex flex-col py-12 px-[0rem] box-border gap-[2rem]">
              ...
              <div className="self-stretch flex flex-col pt-[1.38rem]">
                <div className="self-stretch h-[2rem] flex flex-row items-center justify-start">
                  <div className="flex-1 relative leading-[150%] text-xl text-[#F5F8FF]">
                    Step 2
                  </div>
              ...
              <div className="self-stretch flex flex-col pt-[2rem]">
                <div className="self-stretch h-[2rem] flex flex-row items-center justify-start">
                  <div className="flex-1 relative leading-[150%] text-xl text-[#F5F8FF]">
                    Step 4
                  </div>
          ...
          <div className="w-[70rem] bg-[#fffffa80] rounded-r-xl px-20 py-5">
            ...
            <div className="w-full bg-white p-4 rounded-3xl drop-shadow-[0_2px_10px_rgba(36,36,36,0.1)]">
              ...
              <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 h-[25rem] flex flex-col mx-4 sm:-mx-6 md:mx-0">
                ...
                <p>
                  ข้อตกลงและเงื่อนไขนี้มีผลใช้บังคับระหว่าง กรมพัฒนาธุรกิจการค้า
                  กระทรวงพาณิชย์ ซึ่งต่อไปนี้จะเรียกว่า “ผู้ให้บริการ”
                  กับผู้ลงทะเบียน เพื่อใช้บริการระบบออนไลน์ต่างๆ ของ
                  กรมพัฒนาธุรกิจการค้า ซึ่งต่อไปนี้จะเรียกว่า “ผู้ใช้บริการ”
                ...
                <p>
                  12. ผู้ให้บริการจะเก็บรวบรวมรักษา และใช้ข้อมูลของผู้ใช้บริการ
                  เพื่อประโยชน์ในการให้บริการ หรือเพื่อให้เป็นไปตามกฎหมาย
                  และกฎเกณฑ์ต่างๆ ที่เกี่ยวข้อง หรือเพื่อพัฒนา
                  และปรับปรุงการบริการของผู้ให้บริการ
