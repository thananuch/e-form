                    ...
                    <div className='flex-1 flex flex-col py-12 px-[0rem] box-border items-start justify-start gap-[2rem]'>
                        ...
                        <div className="h-[14.5rem] flex flex-col pt-[1rem] px-[0rem] pb-[0rem] box-border items-start justify-start gap-[1.13rem]">
                            ...
                            <div className="h-[1.5rem] flex flex-row items-center justify-start gap-[0.25rem]">
                                <div className="text-sm my-1 "><AiOutlineCheck></AiOutlineCheck> ข้อมูลส่วนตัว</div>
                            </div>
                            <div className="h-[1.5rem] flex flex-row items-center justify-start gap-[0.25rem] ">
                            ...
                            <div className='w-full mt-4'>
                                ...
                                <div className='grid grid-cols-2 gap-8'>
                                    ...
                                    <div className="grid-flow-row gap-[0.5rem]">
                                        ...
                                        <input placeholder="ระบุ โทรศัพท์มือถือ" maxLength='10'
                                            className="[border:none] bg-style-1-eef0f6 block w-full rounded-xl py-3 px-3 "
                                            type="text"
                                        />
                                    </div>
                                ...
                                <div className='grid grid-flow-row-dense grid-cols-3 gap-8'>
                                    ...
                                    <div className="grid-flow-row gap-[0.5rem] col-span-2">
                                        <div className="text-sm my-1 ">
                                            รายละเอียดที่อยู่ (ถ้ามี) 
                                        </div>
                                        <input placeholder="ห้องเลขที่, ชั้น, อาคาร, หมู่บ้าน" 
                                            className="[border:none] bg-style-1-eef0f6 block w-full rounded-xl py-3 px-3 "
                                            type="text"
                                        />
                                    </div>
                                ...
                                <div className='grid grid-cols-3 gap-8 mt-4'>
                                    <div className="grid-flow-row gap-[0.5rem]">
                                        ...
                                        <select  placeholder="เลือก ตําบล/แขวง" 
                                            className="[border:none] bg-style-1-eef0f6 block w-full rounded-xl py-3 px-3 ">
                                    ...
                                    <div className="grid-flow-row gap-[0.5rem]">
                                        ...
                                        <select placeholder="เลือก อําเภอ/เขต" 
                                            className="[border:none] bg-style-1-eef0f6 block w-full rounded-xl py-3 px-3 "
                                            type="text" >
                                             <option value={0} >เลือก ตําบล/แขวง</option>
                                        </select>
                                    ...
                                    <div className="grid-flow-row gap-[0.5rem]">
                                        ...
                                        <select placeholder="เลือก จังหวัด" 
                                            className="[border:none] bg-style-1-eef0f6 block w-full rounded-xl py-3 px-3 "
                                            type="text" >
                                ...
                                <div className='grid grid-cols-3 gap-8 mt-4'>
                                    <div className="grid-flow-row gap-[0.5rem]">
                                        ...
                                        <select  placeholder="กรุณาเลือก รหัสไปรษณีย์" 
                                            className="[border:none] bg-style-1-eef0f6 block w-full rounded-xl py-3 px-3 ">
                                ...
                                <div className='my-4 flex justify-end mt-8'>
                                    ...
                                    text-white text-lg justify-center text-center w-auto h-auto rounded-3xl px-10 py-3'to="/informationaccount" >
                                        ดำเนินการต่อ
                                    </Link>
                                </div>
