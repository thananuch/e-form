  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 gap-8 mt-4">
        ...
        <div className="grid-flow-row gap-[0.5rem] ">
          <div className="text-sm font-bold my-1 ">วัน-เดือน-ปีเกิด</div>
      ...
      <div className="grid grid-cols-2 gap-8 mt-4">
        <div className="grid-flow-row gap-[0.5rem] ">
          <div className="text-sm font-bold my-1 ">ชื่อ ภาษาอังกฤษ</div>
      ...
      <div className="grid grid-cols-2 gap-8 ">
        ...
        <div className="grid-flow-row gap-[0.5rem] ">
          <div className="text-sm font-bold my-1 ">โทรศัพท์มือถือ</div>
          <div>0900933333</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-8 ">
        <div className="grid-flow-row gap-[0.5rem] ">
          <div className="text-sm font-bold my-1 ">รายละเอียดที่อยู่</div>
          <div>
            เลขที่ 98 ห้องเลขที่ 96/98, ชั้นที่ 6 ,ซอย รัชดาภิเษก 19, ถนน
            รัชดาภิเษก อำเภอ/เขต ดินแดง , ตำบล/แขวง ดินแดง รหัสไปรษณีย์ 10400
          </div>
        </div>
      </div>
    </>
