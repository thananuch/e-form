                ...
                <div className='bg-white w-[40rem] my-4 mx-4 rounded-xl '>
                    <div className='flex mt-3 mb-2 mx-5'>
                        <div className='w-full flex basis-[100%] place-content-between'>
                            <div className='items-start justify-start text-left font-bold text-xl text-[#543FBF]'>
                                ต้องการอัพเดทข้อมูลในนิติบุคคลที่ท่านเป็นกรรมการ/หุ้นส่วนหรือไม่
                            </div>
                            <button className='text-black justify-end items-end bg-transparent border-none text-xl place-self-end' onClick={() => {onClose();}}>x</button>
                        </div>
                    ...
                    <div className='flex px-4 my-4' >
                        <div className='w-full items-start justify-start'>
                            <h5 className='text-lg text-[#939393] font-light my-0 '><BsHandIndex /> เลือกนิติบุคคลที่ต้องการอัพเดทข้อมูล </h5>
                            <div className='w-[90%] mx-auto items-start justify-start text-left'> 
                                <div className='w-full my-4 text-[#222222]'>
                                    <input id='all' type='checkbox' /> <label htmlFor='all'> เลือกทั้งหมด </label>
                                    <div className='mx-5 mt-4'>
                                        <div className='flex flex-row my-2'>
                                            <input id='juristic-1' className='basis-[5%]' type='checkbox' /> 
                                            <label htmlFor='juristic-1' className='basis-[95%] flex flex-row'>  
                                                <div className='basis-[50%]' >บริษัททดสอบระบบ01 จำกัด </div>
                                                <div className='basis-[50%]' > TODSOB01 CO., LTD. </div>
                                            </label>
                                        </div>
                                        <div className='flex flex-row my-2'>
                                            <input id='juristic-2' className='basis-[5%]' type='checkbox' /> 
                                            <label htmlFor='juristic-2' className='basis-[95%] flex flex-row'>  
                                                <div className='basis-[50%]' >บริษัททดสอบระบบ02 จำกัด </div>
