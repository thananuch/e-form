...
function ConfirmEditInformation() {
  ...
  const [showListJuristicForChangeNameModal, setShowListJuristicForChangeNameModal]  = useState(false);
  ...
  return (
    <>
                                ...
                                <div className='w-full my-4 py-4'>
                                    ...
                                    <div className='my-4 flex justify-end mt-8'>
                                        ...
                                        text-white text-lg justify-center text-center w-auto h-auto rounded-3xl px-10 py-3'
                                            onClick={() => setShowListJuristicForChangeNameModal(true)} >
                                            ดำเนินการต่อ
                                        </Link>
                                    </div>
                                </div>
        ...
        <ListJuristicForChangeNameModal isVisible={showListJuristicForChangeNameModal} onClose={() => setShowListJuristicForChangeNameModal(false)} />
    </>
  )
}
