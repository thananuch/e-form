...
function ViewprofilleForDelegate() {
  const changTypeUserSucceed = () => {
    Swal.fire({
      icon: "success",
      title: "แจ้งเตือน",
        ...
        <div className="flex-1 my-10">
          <div className="w-auto ml-8 mr-4 mx-auto rounded-2xl flex flex-row">
            <div className="w-auto py-4 rounded-l-xl bg-gradient-to-b from-977EBB to-6482C2  px-10 flex flex-row gap-[2rem]">
              <div className="bg-[#BABFDF] py-12 px-[0.5rem] items-center justify-start rounded-full flex flex-col gap-[3.38rem] h-[38%]">
...
export default ViewprofilleForDelegate;
