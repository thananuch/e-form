...
function Editinformationaddress() {
  //Test
  const user = {
    id: 0,
    name: "Chidume Ni",
        ...
        <div className="flex-1 my-10">
          <div className="w-auto ml-8 mr-4 bg-[#FDFDFD] rounded-2xl flex flex-row">
            <div className="w-[20rem] py-4 rounded-l-xl bg-gradient-to-b from-977EBB to-6482C2 px-8 flex flex-row gap-[2rem]">
              <div className="bg-[#BABFDF]  py-12 px-[0.5rem] items-center justify-start rounded-full flex flex-col gap-[2rem] h-[32%]">
                <div
...
export default Editinformationaddress;
